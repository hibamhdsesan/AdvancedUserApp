...
import 'NewFav.dart';
import 'Qr/AttendanceOfOneService.dart';
import 'Qr/MyAttendanceOfOneService.dart';
import 'controllers/FavoriteCategory.dart';
import 'controllers/ServiceController.dart';
import 'student_session_view.dart';

class SubjectPageStu extends StatefulWidget {
  @override
  State<SubjectPageStu> createState() => _SubjectPageStuState();
}

class _SubjectPageStuState extends State<SubjectPageStu> {
                                      ...
                                      if (hasChildren)
                                          ...
                                          children: subject.children.map((child) {
                                            return ListTile(
                                              ...
                                              trailing: PopupMenuButton(
                                                ...
                                                onSelected: (value) {
                                                  if (value == 'attendance') {
                                                    Get.to(() => MyServiceAttendance(), arguments: child.id);
                                                  }
                                                },
                                              ),
                                              onTap: () {
                                                ...
                                                Get.to(() => student_session_view(), arguments: serviceId);
                                              },
                                            );
                                          }).toList(),
                                        )
                                        ...
                                        ListTile(
                                          ...
                                          trailing: PopupMenuButton(
                                            ...
                                            onSelected: (value) {
                                              if (value == 'attendance') {
                                                Get.to(() => ServiceAttendance(), arguments: subject.id);
                                              }
                                            },
                                          ),
                                          onTap: () {
